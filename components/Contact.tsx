...
const CHANNELS = [
  {
    label: "Email",
    value: "anukrishna0408@gmail.com",
    href: "mailto:anukrishna0408@gmail.com",
  },
  {
    label: "Phone",
    value: "+91 70203 04620",
    href: "tel:+917020304620",
  },
  {
    label: "LinkedIn",
      ...
      <div className="mx-auto max-w-6xl px-6 py-20 sm:py-28">
        ...
        <div className="mt-3 flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              href="/resume.pdf"
              download="Anila-Unnikrishnan-Resume.pdf"
              className="flex w-fit items-center gap-2 rounded border border-border bg-surface/50 px-6 py-3 font-mono text-xs uppercase tracking-widest text-text transition-transform hover:-translate-y-0.5 hover:text-pass"
            >
